...
CREATE TABLE ENDERECO(
    SEQ NUMBER(2),
    SERHUMANO_ID VARCHAR2(100) NOT NULL,
    ...
    CONSTRAINT PK_ENDERECO PRIMARY KEY (SEQ, SERHUMANO_ID),
    CONSTRAINT FK_END_SERHUMANO FOREIGN KEY (SERHUMANO_ID) REFERENCES SERHUMANO(ID));
/
